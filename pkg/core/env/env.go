...
const (
	...
	SeedStreamIndexerQueryHeaderEnv = "STREAMNZB_INDEXER_QUERY_HEADER"
	SeedStreamIndexerGrabHeaderEnv  = "STREAMNZB_INDEXER_GRAB_HEADER"
	SeedStreamProviderHeaderEnv     = "STREAMNZB_PROVIDER_HEADER"
)
...
func IndexerQueryHeader() string {
	if v := os.Getenv(SeedStreamIndexerQueryHeaderEnv); v != "" {
		return v
	}
...
func IndexerGrabHeader() string {
	if v := os.Getenv(SeedStreamIndexerGrabHeaderEnv); v != "" {
		return v
	}
...
func ProviderHeader() string {
	if v := os.Getenv(SeedStreamProviderHeaderEnv); v != "" {
		return v
	}
